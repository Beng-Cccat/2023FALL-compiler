...
extern MachineUnit mUnit; // ffc-lab6
extern FILE *yyout;
extern Unit unit;
...
void Id::genCode()
{
    ...
    if (type->isInt())new LoadInstruction(dst, addr, bb);//ffclab6
    //fprintf(stderr, "s:%s\n", addr->toStr().c_str());
    //wjc arr
