...
StackMInstrcuton::StackMInstrcuton(MachineBlock *p, int op, std::vector<MachineOperand *> srcs, // m7
                                   MachineOperand *src,
                                   MachineOperand *src1, // m7
                                   int cond)
{
    // TODO
    // m7
