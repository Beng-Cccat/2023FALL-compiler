...
public:
    ...
    static void resetLabel() { counter = 0; };//ffc
};
...
public:
    IdentifierSymbolEntry(Type *type, std::string name, int scope, int paramNo = -1, bool sy=false);
